...
- [copier](https://copier.readthedocs.io/en/stable/): A
...
See the comment above in the "creating a new website" section about
naming the new website folder. It will go through a series of prompts,
as in the case of creating a new website, including asking if you want
...
::: callout-important
The below steps are mostly relevant to the complete template, though
some steps could be done using the simple one as well. Read through
and see if any might apply to your situation if you use the simple
template.
:::
