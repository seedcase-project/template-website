...
-   Choose between [Netlify](https://www.netlify.com/) or [GitHub
    Pages](https://pages.github.com/) for hosting the website. For
    dealing with custom domain names, Netlify is the better choice, as
    the configuration is very easy to set up.
