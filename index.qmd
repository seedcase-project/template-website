...
- Choose between [Netlify](https://www.netlify.com/) or
...
- [`.zenodo.json`](https://help.zenodo.org/docs/github/describe-software/zenodo-json/)
  ...
  metadata to create a DOI for the website.
...
- Uses a [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/)
  license for the website content.
- Includes [GitHub Actions](https://docs.github.com/en/actions) to
  build the website and send it to the hosting provider (see below).
- Choose between [Netlify](https://www.netlify.com/) or
  [GitHub Pages](https://pages.github.com/) for hosting the website. For
  dealing with custom domain names, Netlify is the better choice, as the
  configuration is very easy to set up.
