...
- ⬆️ update pre-commit hook versions (#187)
- :recycle: moved reusable workflow content into template itself (#186)

## 0.23.0 (2026-03-25)

### Feat

- :sparkles: add preview build step (#182)

## 0.22.1 (2026-02-27)

### Fix

- :pencil2: use GitHub Markdown for callout block (#175)
...
- :bug: use correct URLs after checking them (#172)

## 0.21.0 (2026-02-26)

### Feat

- :sparkles: add Quarto book format as option (#171)
- :sparkles: add `communities` tag to `.zenodo.json` (#166)
...
- 🐛 remove reflow-mode, default value works better (#156)
...
- :memo: explain about release process more in CHANGELOG (#132)

## 0.17.9 (2025-11-07)

### Refactor

- :arrow_up: update pre-commit hook versions (#131)
